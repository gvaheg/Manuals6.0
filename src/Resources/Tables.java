...
public class Tables extends All_Functions {
	...
	public void EN_US_PV() {
		try {
			...
			wd.get("https://www.merckmanuals.com/professional/pages-with-widgets/tables?mode=list");
	...
	public void EN_US_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.merckmanuals.com/home/pages-with-widgets/tables?mode=list");
	...
	public void PT_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/pt/profissional/pages-with-widgets/tabelas?mode=list");
	...
	public void PT_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/pt/casa/pages-with-widgets/tabelas?mode=list");
	...
	public void JA_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/ja-jp/professional/pages-with-widgets/%E8%A1%A8?mode=list");
	...
	public void JA_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/ja-jp/home/pages-with-widgets/%E8%A1%A8?mode=list");
	...
	public void FR_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/fr/professional/pages-with-widgets/tableaux?mode=list");
	...
	public void FR_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/fr/accueil/pages-with-widgets/tableaux?mode=list");
	...
	public void ES_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/es/professional/pages-with-widgets/tablas?mode=list");
	...
	public void ES_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/es/hogar/pages-with-widgets/tablas?mode=list");
	...
	public void DE_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/de/profi/pages-with-widgets/tabellen?mode=list");
	...
	public void DE_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/de/heim/pages-with-widgets/tabellen?mode=list");
	...
	public void IT_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/it/professionale/pages-with-widgets/tabelle?mode=list");
	...
	public void IT_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/it/casa/pages-with-widgets/tabelle?mode=list");
	...
	public void RU_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/ru/professional/pages-with-widgets/%D1%82%D0%B0%D0%B1%D0%BB%D0%B8%D1%86%D1%8B?mode=list");
	...
	public void CN_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.cn/professional/pages-with-widgets/tables?mode=list");
			Thread.sleep(2000);
			Thread.sleep(2000);
			// Close Cookies
			try {
	...
	public void CN_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.cn/home/pages-with-widgets/tables?mode=list");
			Thread.sleep(2000);
	...
	public void KO_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/ko/home/pages-with-widgets/%ED%91%9C?mode=list");
	...
	public void MM_VET() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.merckvetmanual.com/pages-with-widgets/tables?mode=list");
	...
	public void MSD_VET() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdvetmanual.com/pages-with-widgets/tables?mode=list");
	...
	public void EN_MSD_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/professional/pages-with-widgets/tables?mode=list");
	...
	public void EN_MSD_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/home/pages-with-widgets/tables?mode=list");
		...
		public void AR_MSD_CV() {
			try {
				wd = new FirefoxDriver();
				wd.get("https://www.msdmanuals.com/ar/home/pages-with-widgets/tables?mode=list");
				System.out.println("VERSION: PROD EN MSD CV");
				verifyTables();
				wd.close();
			} catch (Exception e) {
		...
		public void VI_MSD_PV() {
			try {
				wd = new FirefoxDriver();
				wd.get("https://www.msdmanuals.com/vi/professional/pages-with-widgets/c%C3%A1c-b%E1%BA%A3ng?mode=list");
	...
	public void UK_PV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/uk/professional/pages-with-widgets/tables?mode=list");
	...
	public void HI_CV() {
		try {
			wd = new FirefoxDriver();
			wd.get("https://www.msdmanuals.com/hi/home/pages-with-widgets/tables?mode=list");
