...
public class Daily_Testing_V2_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int j = 0; j < 25; j++) {
			...
			try {
				...
				try {
					WebElement Calc1 = wd.findElement(By.xpath("//*[@id=\"ui-id-5\"]"));
					Calc1.click();
				...
				try {
					WebElement Calc2 = wd.findElement(By.xpath("//*[@id=\"ui-id-6\"]"));
					Calc2.click();
				...
				try {
					WebElement Calc3 = wd.findElement(By.xpath("//*[@id=\"ui-id-7\"]"));
					Calc3.click();
				...
				try {
					WebElement Calc4 = wd.findElement(By.xpath("//*[@id=\"ui-id-8\"]"));
					Calc4.click();
			...
			try {
				...
				try {
					...
					List<WebElement> Letters = wd.findElements(By.xpath("//*[@class=\"letterspine__letter\"]"));
					int size = Letters.size();
					System.out.println(size / 2);
					int randnMumber = ThreadLocalRandom.current().nextInt(0, size / 2);
					try {
						Letters.get(randnMumber).click();
					} catch (Exception e) {
						System.out.println("Can't Click on Letter");
					}

					Thread.sleep(1000);
					List<WebElement> TopicTitles = wd.findElements(By.xpath("//*[@class=\"modalspine__toplevel\"]/a"));

					int sizeTitles = TopicTitles.size();
					System.out.println(sizeTitles / 2);
					int randnMumberTopics = ThreadLocalRandom.current().nextInt(0, sizeTitles / 2);
					try {
						TopicTitles.get(randnMumberTopics).click();
					} catch (Exception e) {
						System.out.println("Can't Click on Letter");
					}
				...
				try {
					WebElement TopicTitle = wd
							.findElement(By.xpath("//h1[@class='topic__header--title topic__header--title--animate']"));
