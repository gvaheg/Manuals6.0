...
public class CombinedScript {
    ...
    public static void main(String[] args) {
        ...
        XSSFCellStyle yellowStyle = createCellStyle(workbook, new Color(255, 255, 0)); // Yellow
        ...
        try {
            ...
            for (String url : urls) {
                ...
                for (Map<String, Object> result : results) {
                    ...
                    String xpath = (String) result.get("xpath");
                    ...
                    boolean isScriptOrNextData = xpath.toLowerCase().contains("script") || xpath.toLowerCase().contains("next_data");
             ...
             // Delay between processing URLs
                Thread.sleep(500); // Wait 5 seconds to avoid rate limiting
            }
