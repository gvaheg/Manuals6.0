...
public class Lighthouse_V3 {
	...
	public static void main(String[] args) throws Exception {
		...
		mainURLs[0] = "https://pagespeed.web.dev/report?url=https%3A%2F%2Fwww.merckmanuals.com%2Fprofessional";
		Versions[0] = "EN PV Home Merck";
		
		mainURLs[1] = "https://pagespeed.web.dev/report?url=https%3A%2F%2Fwww.msdmanuals.com%2Fprofessional";
		...
		for (int j = 0; j < 69; j++) {
			...
			try {
				...
				try {
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//div[@aria-labelledby='mobile_tab']//div[@class='lh-gauge__percentage']")));
				} catch (Exception e) {
				...
				WebElement performance = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//div[@class='lh-gauge__percentage']"));
...
/*
				...
				//Thread.sleep(500);
				// seo
				WebElement seo = wd.findElement(By.xpath(""));
...
*/
				...
				WebElement firstcontentfulpaint = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//*[@id=\"first-contentful-paint\"]/div/div[2]"));
				...
				WebElement speedindex = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//*[@id=\"speed-index\"]/div/div[2]"));
				...
				WebElement largestcontentfulpaint = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//*[@id=\"largest-contentful-paint\"]/div/div[2]"));
				...
				WebElement interactive = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//*[@id=\"interactive\"]/div/div[2]"));
				...
				WebElement totalblockingtime = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//*[@id=\"total-blocking-time\"]/div/div[2]"));
				...
				WebElement cumulativelayoutshift = wd
						.findElement(By.xpath(".//div[@aria-labelledby='mobile_tab']//*[@id=\"cumulative-layout-shift\"]/div/div[2]"));
				...
				FileOutputStream fout = new FileOutputStream("C:\\users\\gvahe\\Desktop\\LighthouseTwo.xlsx");
				wb.write(fout);
				fout.close();
