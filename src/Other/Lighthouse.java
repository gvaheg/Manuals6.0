...
public class Lighthouse {
	...
	public static void main(String[] args) throws Exception {
		...
		mainURLs[0] = "https://googlechrome.github.io/lighthouse/viewer/?psiurl=https%3A%2F%2Fwww.merckmanuals.com%2Fprofessional&strategy=mobile&category=performance&category=accessibility&category=best-practices&category=seo&category=pwa&utm_source=lh-chrome-ext";
		Versions[0] = "EN PV Home Merck";
		
		mainURLs[1] = "https://googlechrome.github.io/lighthouse/viewer/?psiurl=https%3A%2F%2Fwww.msdmanuals.com%2Fprofessional&strategy=mobile&category=performance&category=accessibility&category=best-practices&category=seo&category=pwa&utm_source=lh-chrome-ext";
		Versions[1] = "EN PV Home";
		
		mainURLs[2] = "https://googlechrome.github.io/lighthouse/viewer/?psiurl=https%3A%2F%2Fwww.msdmanuals.com%2Fde%2Fprofi&strategy=mobile&category=performance&category=accessibility&category=best-practices&category=seo&category=pwa&utm_source=lh-chrome-ext";
		Versions[2] = "DE PV Home";
		
		mainURLs[3] = "https://googlechrome.github.io/lighthouse/viewer/?psiurl=https%3A%2F%2Fwww.msdmanuals.com%2Fes%2Fprofessional&strategy=mobile&category=performance&category=accessibility&category=best-practices&category=seo&category=pwa&utm_source=lh-chrome-ext";
		Versions[3] = "ES PV Home";
		
		mainURLs[4] = "https://googlechrome.github.io/lighthouse/viewer/?psiurl=https%3A%2F%2Fwww.msdmanuals.com%2Ffr%2Fprofessional&strategy=mobile&category=performance&category=accessibility&category=best-practices&category=seo&category=pwa&utm_source=lh-chrome-ext";
		...
		for (int j = 0; j < 69; j++) {
			...
			WebDriverWait wait = new WebDriverWait(wd, Duration.ofSeconds(70));
			try {
				...
				try {
					...
					WebElement performance = wd
							.findElement(By.xpath(".//a[@href='#performance']/div[@class='lh-gauge__percentage']"));
					...
					rowN.createCell(1).setCellValue("Fail");
				}
				try {
					// accessibility
					WebElement accessibility = wd
							.findElement(By.xpath(".//a[@href='#accessibility']/div[@class='lh-gauge__percentage']"));
					...
					System.out.println("accessibility: Fail");
					rowN.createCell(2).setCellValue("Fail");
				}
				try {
					// best-practices
					WebElement bestpractices = wd
							.findElement(By.xpath(".//a[@href='#best-practices']/div[@class='lh-gauge__percentage']"));
					...
					System.out.println("best-practices: Fail");
					rowN.createCell(3).setCellValue("Fail");
				}
				try {
					// seo
					WebElement seo = wd.findElement(By.xpath(".//a[@href='#seo']/div[@class='lh-gauge__percentage']"));
					System.out.println("seo: " + seo.getAttribute("innerHTML"));
					rowN.createCell(4).setCellValue(seo.getAttribute("innerHTML"));
				} catch (Exception e) {
					System.out.println("seo: Fail");
				...
				try {
					...
					WebElement firstcontentfulpaint = wd
							.findElement(By.xpath("//*[@id='first-contentful-paint']//div[@class='lh-metric__value']"));
					...
					System.out.println("first-contentful-paint: Fail");
					rowN.createCell(5).setCellValue("Fail");
				}
				try {
					// speed-index
					WebElement speedindex = wd
							.findElement(By.xpath("//*[@id=\"speed-index\"]//div[@class='lh-metric__value']"));
					System.out.println("speed-index: " + speedindex.getText());
					rowN.createCell(6).setCellValue(speedindex.getText());
				} catch (Exception e) {
					System.out.println("speed-index: Fail");
					rowN.createCell(6).setCellValue("Fail");
				}
				try {
					// largest-contentful-paint
					WebElement largestcontentfulpaint = wd.findElement(
							By.xpath("//*[@id=\"largest-contentful-paint\"]//div[@class='lh-metric__value']"));
					...
					System.out.println("largest-contentful-paint: Fail");
					rowN.createCell(7).setCellValue("Fail");
				}
				try {
					// interactive
					WebElement interactive = wd
							.findElement(By.xpath("//*[@id=\"interactive\"]//div[@class='lh-metric__value']"));
					System.out.println("interactive: " + interactive.getText());
					rowN.createCell(8).setCellValue(interactive.getText());
				} catch (Exception e) {
					System.out.println("interactive: N/A");
					rowN.createCell(8).setCellValue("N/A");
				}
				try {
					// total-blocking-time
					WebElement totalblockingtime = wd
							.findElement(By.xpath("//*[@id=\"total-blocking-time\"]//div[@class='lh-metric__value']"));
					System.out.println("total-blocking-time: " + totalblockingtime.getText());
					rowN.createCell(9).setCellValue(totalblockingtime.getText());
				} catch (Exception e) {
					System.out.println("total-blocking-time: Fail");
					rowN.createCell(9).setCellValue("Fail");
				}
				try {
					// cumulative-layout-shift
					WebElement cumulativelayoutshift = wd.findElement(
							By.xpath("//*[@id=\"cumulative-layout-shift\"]//div[@class='lh-metric__value']"));
					...
					System.out.println("cumulative-layout-shift: Fail");
					rowN.createCell(10).setCellValue("Fail");
				}
				FileOutputStream fout = new FileOutputStream("C:\\TestResults\\Lighthouse.xlsx");
				wb.write(fout);
				fout.close();
