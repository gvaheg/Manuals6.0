...
public class BrandingAndResponseCodesRU {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesRU.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/ru/sitemap.ashx");
            if (urls.isEmpty()) {
