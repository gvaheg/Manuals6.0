...
public class BrandingAndResponseCodesJA {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesJA.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/ja/sitemap.ashx");
            if (urls.isEmpty()) {
