...
public class BrandingAndResponseCodesVET {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesVET.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdvetmanual.com/sitemap.ashx");
            if (urls.isEmpty()) {
