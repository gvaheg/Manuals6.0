...
public class BrandingAndResponseCodesFR {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesFR.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/fr/sitemap.ashx");
            if (urls.isEmpty()) {
