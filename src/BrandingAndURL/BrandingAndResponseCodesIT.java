...
public class BrandingAndResponseCodesIT {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesIT.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/it/sitemap.ashx");
            if (urls.isEmpty()) {
