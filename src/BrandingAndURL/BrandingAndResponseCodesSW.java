...
public class BrandingAndResponseCodesSW {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesSW.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/sw/sitemap.ashx");
            if (urls.isEmpty()) {
