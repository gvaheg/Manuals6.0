...
public class BrandingAndResponseCodesVI {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesVI.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/vi/sitemap.ashx");
            if (urls.isEmpty()) {
