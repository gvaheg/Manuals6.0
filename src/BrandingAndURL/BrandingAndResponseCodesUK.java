...
public class BrandingAndResponseCodesUK {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesUK.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/uk/sitemap.ashx");
            if (urls.isEmpty()) {
