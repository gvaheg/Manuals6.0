...
public class BrandingAndResponseCodesJAJP {
    ...
    public static void main(String[] args) {
        ...
        // Output file path
        String outputFilePath = "C:\\TestResults\\BrandingAndResponseCodesJAJP.xlsx";
        ...
        try {
            List<String> urls = getUrlsFromSitemap("https://www.msdmanuals.com/ja-jp/sitemap.ashx");
            if (urls.isEmpty()) {
