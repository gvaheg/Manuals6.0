...
public class All_Functions6COPY {
					...
					for (int i = 1; i < rowCount + 1; i++) {
						try {
							...
							*/
							...
							try {
								WebElement location = wd.findElement(By.xpath("//div[@class='accordionSection_carouselContainer__Y5UzM']//div/div[1]//div[2]/a"));
	...
	try {
		...
		try {
		    ...
		    // If element not found with original xpath, try the new xpath
